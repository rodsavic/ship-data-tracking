...
@Component({
  selector: 'app-dashboard-gases-de-escape-sox',
  imports: [NgxEchartsDirective],
  templateUrl: './dashboard-gases-de-escape-sox.component.html',
  styleUrls: ['./dashboard-gases-de-escape-sox.component.css']
})
export class DashboardGasesDeEscapeSoxComponent implements OnInit, OnDestroy {
